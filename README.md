...
![LangChain](docs/images/langchain.svg)      ![LangGraph](docs/images/langgraph.svg)      ![LangSmith](docs/images/langsmith.svg)
...
![TechCorp IT Helpdesk login screen with five demo users, each with different roles and departments](docs/screenshots/login-screen.png)

> This repository demonstrates real attacks against AI agents so engineers can learn to defend
...
![LangChain middleware hooks firing before and after the model and tool steps of the agent loop](docs/images/langchain-middleware.png)

The LangChain agent loop and its middleware hooks. Diagram from the [LangChain middleware docs](https://docs.langchain.com/oss/python/langchain/middleware/overview).